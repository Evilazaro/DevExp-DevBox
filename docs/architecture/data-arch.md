...
**Source:** [infra/main.bicep](infra/main.bicep) lines 33-35,
[src/workload/workload.bicep](src/workload/workload.bicep) line 45
...
| ------ | --------------------------------------------------------------- | --------------- | -------- |
| TD-D01 | No diagram template file exists (`Data-diag-temp.md` not found) | Minor           | LOW      |
| TD-D02 | Schema files reference external URLs that may change            | Potential drift | LOW      |
...
**Source:** [infra/main.bicep](infra/main.bicep) line 33,
...
line 29 (`softDeleteRetentionInDays: 7`)
...
| ------- | ------------------------------------ | --------------------------------- | ----------------------------------- | -------- | ---------- |
| GAP-D01 | No data diagram template             | Data-diag-temp.md should exist    | Missing diagram template file       | LOW      | LOW        |
| GAP-D02 | Example Azure AD Group IDs in config | Real Azure AD Group IDs           | Placeholder values need replacement | MEDIUM   | LOW        |
| GAP-D03 | Schema references external URLs      | Local or stable schema references | External dependency on schema URLs  | LOW      | MEDIUM     |
...
| Phase 3 | Template Enhancement | Future      | Create Data-diag-temp.md if needed       | None              |

### Key Milestones

| ID    | Milestone                              | Target Date | Success Criteria                         | Status      |
| ----- | -------------------------------------- | ----------- | ---------------------------------------- | ----------- |
| M-D01 | Data architecture documentation        | 2026-01-31  | Document published to docs/architecture/ | Complete    |
...
| ------------------------------------ | ----------------------- | -------------------------------------------- |
| No Data-diag-temp.md template file   | Minor - diagrams inline | Created diagrams directly in document        |
...
| ------------------------------ | ------------------------------------------------------ | ---------------- |
| Business Layer Architecture    | [docs/architecture/business-arch.md](business-arch.md) | Parent layer     |
