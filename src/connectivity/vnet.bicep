...
resource virtualNetwork 'Microsoft.Network/virtualNetworks@2025-05-01' = if (settings.create && settings.virtualNetworkType == 'Unmanaged') {
  name: settings.name
  location: location
...
resource existingVirtualNetwork 'Microsoft.Network/virtualNetworks@2025-05-01' existing = if (!settings.create && settings.virtualNetworkType == 'Unmanaged') {
  name: settings.name
